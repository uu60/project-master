<template>
    <div>
        <el-container>
            <!--菜单栏-->
            <el-header>
                <el-row style="min-width: 1300px" type="flex" justify="space-between">
                    <!--导航栏-->
                    <el-col span="10">
                        <div>
                            <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" style="min-width: 200px">
                                <el-menu-item index="/MainComponent/Home">Dashboard</el-menu-item>
                    ...
                    <el-col :span="2">
                        <i class="el-icon-user-solid" style="font-size: 15px; margin-top: 22px; margin-right: 5px"></i>
                        <el-dropdown>
                ...
                axios.get(`/api/display/api/v1/data/daily/${this.$data.keyword}?fromDate=${thirtyDaysAgo.toISOString()}&toDate=${today.toISOString()}`, {
                    ...
                    .then(res => {
                        ...
                        if (res.data.code == 0) {
                          ...
                          axios.get(`/api/display/api/v1/data/update/${this.keyword}`, {
                            headers: {
                              // 'Authorization': 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ3enkiLCJhdXRob3JpdGllcyI6W10sImlhdCI6MTY4NzE4NDc3OCwiZXhwIjoxNjkyMzc0NDAwfQ.dcSj9KbPIlhum11f_93f6CkgEamQAjTUbD3HJ60U-CE',
                              'Authorization': localStorage.getItem('token'),
                              'Content-Type': 'application/json'
